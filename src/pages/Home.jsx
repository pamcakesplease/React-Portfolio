...
const Home = () => {
  return (
    ...
    <div className="container mx-auto">
      ...
      <img src="/images/me.png" className="object-cover h-80 w-96" id="picture"></img>
  ...
  <img class="h-60 w-96 aspect-square" id="project-image" src="images/project-1.png" /></a>
  <p id="project-title">Weather Dashboard</p>
  <a href ="https://pamcakesplease.github.io/Weather-Dashboard/">
  <img class="h-60 w-96 aspect-square" id="project-image" src="images/project-2.png" /></a>
  <p id="project-title">GGz</p>
  <a href ="https://github.com/Spaghedward/GGz?tab=readme-ov-file">
  <img class="h-60 w-96 aspect-square" id="project-image" src="images/project-3.png" /></a>
</div>
    </div>
    </body>
    </>
